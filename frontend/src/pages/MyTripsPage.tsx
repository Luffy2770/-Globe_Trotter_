...
import { Search, Calendar, MapPin, DollarSign, Clock, PlusCircle, ArrowUpRight, Heart } from 'lucide-react';
    ...
    >
      ...
      <div className="flex justify-end space-x-2 pt-1">
        <button
          ...
          className="py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold rounded-xl transition flex items-center space-x-1"
        >
        ...
        <button
          ...
          className="py-2.5 px-4 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-xl shadow-xs transition flex items-center space-x-1"
        >
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8 animate-scale-up relative pb-24">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">My Trips & Vacation Plans</h1>
          <p className="text-xs text-slate-500 font-medium">Manage current ongoing trips, past completed trips, and wishlist vacations.</p>
        </div>

        <button
          onClick={onOpenCreateModal}
          className="py-2.5 px-5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl text-xs flex items-center space-x-2 shadow-xs transition active:scale-[0.98]"
        >
        ...
        <div className="space-y-8">
          ...
          {(!statusFilter || statusFilter === 'ongoing') && (
            <div className="space-y-4">
              <h2 className="text-base font-bold text-slate-900 flex items-center space-x-2 border-b border-slate-200 pb-2">
